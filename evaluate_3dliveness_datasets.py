...
def eval_datasets(args):
    global device
    save_path = '/home/disk01/wyw/pytorchFeathernet/false_class_img'
    ...
    net = FeatherNet.FeatherNet(num_class=args.class_num, input_size=args.img_size, input_channels=1, is_training=True,
    ...
    img_test1 = dataset.get_3d_liveness_data_imgpath(args.test_data, 'test', True)
    ...
    '''
    for i, data in enumerate(img_test1):
        #print(i)
        inputpath, label = img_test1[i]
        print(inputpath)
    '''
...
def parse_arguments():
    ...
    #parser.add_argument('-Save_model', type=str, help='model save path.', default='./liveness_training_record_0328/model')
    #parser.add_argument('-Save_tensorboard', type=str, help='tensorboard save path.', default='./liveness_training_record_0328/log')
    parser.add_argument('-Save_model', type=str, help='model save path.', default='./2d_3d_liveness_training_record_0702/model')
    parser.add_argument('-Save_tensorboard', type=str, help='tensorboard save path.', default='./2d_3d_liveness_training_record_0702/log')
    ...
    #parser.add_argument('-model_path', type=str, help='load the model path', default='./liveness_training_record_0328/model/0328_1023/Feathernet_70.pkl')
    parser.add_argument('-model_path', type=str, help='load the model path', default='./2d_3d_liveness_training_record_0702/model/0702_1358/Feathernet_160.pkl')
    # set the img data
    '''test data'''
    #parser.add_argument('-test_data', type=str, help='data for testing', default='./test_data/irData_1026_real0328')
    #parser.add_argument('-test_data', type=str, help='data for testing', default='/home/disk04/YZhang/zhangyanWork/datas/irDatas/irTest1026/fake')
    #parser.add_argument('-test_data', type=str, help='data for testing', default='./NIR_face_dataset/save_real_jpg')
    parser.add_argument('-test_data', type=str, help='data for testing', default='/home/disk01/wyw/NIR-VIS/SAVE_NIR_real')
