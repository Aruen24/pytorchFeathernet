...
def eval_datasets(args):
    global device
    save_path = '/home/wyw/pytorchFeathernet/false_class_img'
...
def parse_arguments():
    ...
    parser.add_argument('-Save_model', type=str, help='model save path.',
                        default='./liveness_training_record_0328/model')
    parser.add_argument('-Save_tensorboard', type=str, help='tensorboard save path.',
                        default='./liveness_training_record_0328/log')
    ...
    parser.add_argument('-model_path', type=str, help='load the model path',
                        default='./liveness_training_record_cbam_0329/model/0329_1029/Feathernet_160.pkl')
    # set the img data
    '''test data'''
    #parser.add_argument('-test_data', type=str, help='data for testing',
    #                    default='./test_data/irData_1026_fake0328')
    parser.add_argument('-test_data', type=str, help='data for testing',
                        default='./test_data/test_fake0328')
