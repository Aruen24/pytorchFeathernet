...
# parser.add_argument('-Save_model', type=str, help='model save path.',default='/home/data03_disk/YZhang/liveness_training_record/model')
# parser.add_argument('-Save_tensorboard', type=str, help='tensorboard save path.',default='/home/data03_disk/YZhang/liveness_training_record/log')
# parser.add_argument('-Save_model', type=str, help='model save path.',default='./liveness_training_record/model')
# parser.add_argument('-Save_tensorboard', type=str, help='tensorboard save path.',default='./liveness_training_record/log')
#parser.add_argument('-Save_model', type=str, help='model save path.', default='./2d_3d_liveness_training_record_0701/model')
parser.add_argument('-Save_model', type=str, help='model save path.', default='./2d_3d_liveness_training_record_0704/model')
#parser.add_argument('-Save_tensorboard', type=str, help='tensorboard save path.',default='./2d_3d_liveness_training_record_0701/log')
parser.add_argument('-Save_tensorboard', type=str, help='tensorboard save path.',default='./2d_3d_liveness_training_record_0704/log')
...
parser.add_argument('-learn_rate', type=float, help='learn decay rate', default=0.01)
...
def evaluateing(net, test_loader, epoch, model_dir):
    ...
    record.write(
        'Epoch:{0}\ttest_acc:{1:.5f}\tFRR:{2:.5f}\tFAR:{3:.5f}\n'.format(epoch, result[2], result[1], result[0]))
    record.close()
