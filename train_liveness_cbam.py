...
#parser.add_argument('-Save_model', type=str, help='model save path.',default='./liveness_cbam_training_record/model')
#parser.add_argument('-Save_tensorboard', type=str, help='tensorboard save path.',default='./liveness_cbam_training_record/log')
parser.add_argument('-Save_model', type=str, help='model save path.', default='./liveness_training_record_cbam_0329/model')
parser.add_argument('-Save_tensorboard', type=str, help='tensorboard save path.',
                    default='./liveness_training_record_cbam_0329/log')
#parser.add_argument('-batch_size', type=int, help='batch size for training', default=128)
parser.add_argument('-batch_size', type=int, help='batch size for training', default=380)
...
parser.add_argument('-train_face', type=str, help='data for training',
                    default='/home/data03_disk/wyw_data/irDatas/binocular_liveness_data/ir_train')
"""""""""""""test data"""""""""""""
# parser.add_argument('-test_face', type=str, help='data for testing',
#                    default='/home/data03_disk/wyw_data/irDatas/irTest0719')

parser.add_argument('-test_face', type=str, help='data for testing',
                    default='/home/data03_disk/wyw_data/irDatas/binocular_liveness_data/ir_test')
